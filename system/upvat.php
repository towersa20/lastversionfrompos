...
<form name="form1" method="post" action="" enctype="multipart/form-data">
    ...
    <tr>
      <td colspan="6" class="">تعديــل أسم الضريبة <i class="fab fa-accusoft"></i> </td>
    </tr>
    <tr>
      <td nowrap style="width:8%; ">الضريبة</td>
    ...
    <tr>
      ...
      <td style="width:15%;"><button  type="submit" name="ok" class="btn btn btn-primary" style="width:100%;font-family: 'Droid Arabic Kufi';"> تعديل <i class="fa fa-check"></i></button></td>
      <td style="width:15%;"><a href="index.php"><button type="button" class="btn btn-info" style="width:100%;font-family: 'Droid Arabic Kufi';"> النظام <i class="fa fa-home"></i></button></a></td>
    </tr>
  </table>
</form></div>
</body>
