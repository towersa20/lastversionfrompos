...
<div class="app-content content container-fluid">
    <form name="form1" method="post" action="" enctype="multipart/form-data">
          <table style="width:100%;" border="1" align="center" dir="rtl" class="table table-bordered table-hover">
                  <tr><td colspan="6" class="">تعديــل بيانات وصلاحية المستخدم <i class="fa fa-user"></i></td></tr>
<tr>
    <td nowrap style="width:5%;">الأسم الكامـل </td>
<td colspan="3"><input type="text" name="a" value="<?php echo $row['name'];?>" class="form-control big-shadow" required autocomplete="off">
    </td>

<td style="width:7%; ">الصلاحيــــــــة</td>
...
<tr>
<td style="width:5%; ">رقم الهاتــــف</td>
...
<td style="width:15%;"></td>
<td style="width:15%;"></td>
<td style="width:15%;" align="left"><button type="submit" name="ok" class="btn btn-primary" style="width:100%; font-family: 'Droid Arabic Kufi';"> تعديـل <i class="fa fa-edit"></i></button></td>
<td style="width:15%;" align="left"><a href="index.php"><button type="button" name="ok" class="btn btn-danger" style="width:100%; font-family: 'Droid Arabic Kufi';"> النظام <i class="fa fa-home"></i></button></a></td>
  </tr>
  </table>
</form></div>
</body>
   ...
   <div class="modal-dialog modal-notify modal-success" role="document">
     ...
     <div class="modal-content">
       ...
       <div class="modal-header">
         <strong class="heading lead">تعديل بيانات المستخدم</strong>
