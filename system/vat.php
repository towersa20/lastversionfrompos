...
<form name="form1" method="post" action="vat.php">
  <table style="width:100%; " align="center" class="table table-bordered table-hover animated " >
    ...
    <tr>
      <td colspan="5">تسجيل القيمة المضافة <i class=" fab fa-accusoft "></i> </td>
    </tr>
    <tr>
      <td nowrap style="width:8%;">اسم الضريبة</td>
      <td style="width:60%;"><input type="text"   name="a" class="form-control " required autocomplete="off"></td>
      <td style="width:8%;">النسبة</td>
  ...
  <table style="width:100%; " align="center" class="table table-borderd table-hover  " >
    <tr>
      ...
      <td style="width:25%;"><button  type="submit" name="ok" class="btn btn-primary" style="width:100%;font-family: 'Droid Arabic Kufi';"> تسجيل <i class="fa fa-check"></i></button></td>
...
?>
<tr align="center">
<td style="width:50%; ">إسم القيمة</td>
<td style="width:15%; ">الضريبــة</td>
...
<td align="center"><a href="delete.php?&&vatid=<?php echo $row['vid'];?>" onClick="return confirm('هل تريد حذف <?php echo $row['name'];?>');">
...
<td align="center"><a href="upvat.php?&&vatid=<?php echo $row['vid'];?>">
        <button class="btn btn-info" style="width:100%;font-family: 'Droid Arabic Kufi';"> تعديل <i class="fa fa-edit"></i></button>
    </a></td>
</tr>
