...
<div><h3 align="center" style="font-family:Droid Arabic Kufi;">نافذة إجراء النسخ الإحتياطي اليدوي</h3></div>	
     <div class="form-wrap">
...
<button type="submit" name="backupnow" class="btn btn-rounded btn-primary" style="width:600px; height:120px; font-size:35px; color:white; "> النسخ الإحتياطي <i class="fa fa-qrcode danger font-large-2"></i></button>
