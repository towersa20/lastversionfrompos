...
<tr>
<td colspan="8" >نافذة سداد مستحقات الموردين <i class="fa fa-user"></i></td></tr>
<?php 
...
<td style="width:9%;">السداد</td>
<td><?php echo $rw['costst'];?></td>
<td style="width:9%;">المطلوب</td>
<td>
...
$querys=mysql_fetch_array($links);
 echo $querys['sum(total)']-$querys['sum(pay)'];?></td>
         ...
         <table style="width:100%; font-size:12px;" border="1" align="center" class="table table-bordered table-hover">
<tr><td colspan="7">تفاصيل الصنف <i class="fa fa-user"></i></td></tr>
         <?php include('dbcon/dbcon.php');
...
<tr>
             ...
             <td style="width:15%;"><button type="submit" name="ok" class="btn btn-primary" style="width: 100%;  font-family: 'Droid Arabic Kufi';"> حفـــظ <i class="fab fa-accusoft"></i></button></td>
             <td style="width:15%;"><a href="custompayment.php"><button type="button" class="btn " style="width: 100%;  font-family: 'Droid Arabic Kufi'; background-color: green;"> جديد <i class="fa  fas fa-cogs"></i></button></a></td>
             <td style="width:15%;"><a href="vpayment.php"><button type="button" class="btn btn-primary" style="width: 100%;  font-family: 'Droid Arabic Kufi';"> بحث <i class="fa fa-search"></i></button></a></td>
             <td style="width:15%;"><a href="repcust2.php"><button type="button" class="btn btn-danger" style="width: 100%;  font-family: 'Droid Arabic Kufi';"> التقارير <i class="fa mdi mdi-scatter-plot"></i></button></a></td>
             <td style="width:15%;"><a href="record.php"><button type="button" class="btn btn-warning" style="width: 100%;  font-family: 'Droid Arabic Kufi'; background-color: #000;"> رجــوع <i class="fa fa-undo"></i></button></a></td>
             <td style="width:15%;">&nbsp;</td>
         </tr>
     </table>
...
<td align="center"><a href="delete.php?&&pxid=<?php echo $row['pxid'];?>&&xname=<?php echo $_POST['xname'];?>" onClick="return confirm('هل تريد حذف  <?php echo $row['codes'];?>');">
