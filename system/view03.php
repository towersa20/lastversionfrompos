...
<li class="nav-item"><a class="nav-link active" id="active-tab" data-toggle="tab" href="#active" aria-controls="active" aria-expanded="true"></a></li>
						</ul>
...
<tr>
<td><a href="rselect1.php"><input type="button" class="form-control round btn-success" value="التقرير اليومي"></a></td>
<td colspan="2"><a href="rselect2.php"><input type="button" class="form-control round btn-success" value="التقرير الدوري"></a></td>
<td><a href="rselect3.php"><input type="button" class="form-control round btn-success" value="التقرير السنوي"></a></td>
</tr>
</table>
							<br>
							<br>
