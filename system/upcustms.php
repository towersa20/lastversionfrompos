...
<form name="form1" method="post" action="" enctype="multipart/form-data">
  <table style="width:100%; font-size: 14px; " align="center" class="table table-bordered table-hover">
    ...
    <tr>
      ...
      <td style="width:15%;"><button  type="submit" name="ok" class="btn btn-primary" style="width:100%; width: 100%; font-family: 'Droid Arabic Kufi';""> تعديل <i class="fa fa-check"></i></button></td>
      <td style="width:15%;"><a href="customer.php"><button type="button" class="btn btn-success" style="width:100%; width: 100%; font-family: 'Droid Arabic Kufi';""> رجوع <i class="fa fa-undo"></i></button></a></td>
    </tr>
  </table></form></div>
</body>
</html>
