...
<div class="card">
	<div class="card-header">
		<h4 class="card-title">نظام إدارة المبيعات والمشتريات والتخزين</h4>
</div>
	<div class="card-body">
		<div class="card-block">
						<ul class="nav nav-tabs nav-justified">
<li class="nav-item"><a class="nav-link active" id="active-tab" data-toggle="tab" href="#active" aria-controls="active" aria-expanded="true"><input type="button" class="form-control round btn-warning" value="تقارير المصروفات"></a></li>
						</ul>
...
<tr>
<td><a href="rexpn1.php"><input type="button" class="form-control round btn-success" value="التقرير اليومي"></a></td>
<td colspan="2"><a href="rexpn2.php"><input type="button" class="form-control round btn-success" value="التقرير الدوري"></a></td>
<td><a href="rexpn3.php"><input type="button" class="form-control round btn-success" value="التقرير السنوي"></a></td>
</tr>
</table>
<table class="table table-borderd table-hover">
<tr><td colspan="4"><input type="button" class="form-control round btn-primary" value="تقارير سجل مدفوعـات المورديــن"></td>
</tr>
<tr>
<td><a href="rpay1.php"><input type="button" class="form-control round btn-black" value="التقرير اليومي"></a></td>
<td colspan="2"><a href="rpay2.php"><input type="button" class="form-control round btn-black" value="التقرير الدوري"></a></td>
<td><a href="rpay3.php"><input type="button" class="form-control round btn-black" value="التقرير السنوي"></a></td>
</tr>
<tr>
<td colspan="4"><a href="xrpay.php"><input type="button" class="form-control round btn-black" value="التقرير التفصيـلي لعمليات السداد"></a></td>
</tr>
</table>
							<br>
							<br>
...
<tr>
<td><a href=""><input type="button" class="form-control round btn-warning" value="بيع صنف"></a></td>
<td><a href=""><input type="button" class="form-control round btn-warning" value="بيع اصناف"></a></td>
<td><a href=""><input type="button" class="form-control round btn-warning" value="تعديل فاتورة"></a></td>
<td><a href=""><input type="button" class="form-control round btn-warning" value="إستعلام مبيعات"></a></td>
</tr>
<tr>
<td colspan="2"><input type="button" class="form-control round btn-primary" value="بيع أصناف  باركــود"></td>
</tr>
<tr>
<td><a href=""><input type="button" class="form-control round btn-warning" value="بيع صنف"></a></td>
<td><a href=""><input type="button" class="form-control round btn-warning" value="بيع اصناف"></a></td>
...
<tr>
<td><a href=""><input type="button" class="form-control round btn-warning" value="التقرير اليومي"></a></td>
<td><a href=""><input type="button" class="form-control round btn-warning" value="التقرير الدوري"></a></td>
<td><a href=""><input type="button" class="form-control round btn-warning" value="التقرير الشهري"></a></td>
<td><a href=""><input type="button" class="form-control round btn-warning" value="التقرير السنــوي"></a></td>
</tr>
</table>
			<br>
							<br>
...
<td><a href="ritem.php"><input type="button" class="form-control round btn-success" value="تقارير الأصناف"></a></td>
</tr>
</table>
							<br>
							<br>
