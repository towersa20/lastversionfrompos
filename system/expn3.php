...
<table style="width:100%;" border="1" align="center" class="table table-bordered table-hover ">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            ...
            <td align="center"><strong> تقرير المصروفات للعام لسنة <?php echo $_POST['year'];?></strong></td>
...
<table dir="rtl" style="width:100%;" border="1" align="center" class="table table-bordered table-hover ">  <tr  >
  ...
  <?php include('dbcon/config.php');
  $sql=mysql_query("select * from expn where year='$_POST[year]'");
  ...
  <tr >
    ...
    <td nowrap ><?php include('dbcon/config.php');	$sql=mysql_query("select count(exid) from expn where year='$_POST[year]'"); $row=mysql_fetch_array($sql); echo $row['count(exid)'];?></td>
<td></td>
    <td nowrap><strong>الإجمالي</strong></td>
    <td nowrap ><?php include('dbcon/config.php');	$sql=mysql_query("select sum(cost) from expn where year='$_POST[year]'");
	 $row=mysql_fetch_array($sql); echo $row['sum(cost)'];?> ريال </td>
  </tr>
</table>
<br>
...
<table style="width:100%;" border="1" align="center" class="table table-bordered table-hover ">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            <td align="center">التاريخ <?php echo date('y-m-d h:i:s');?></td>
            <td align="center"><strong> تقرير مصروفات <?php echo $_POST['exp'];?> للعام <?php echo $_POST['year'];?></strong></td>
            <td align="center"> تقارير المصروفات </td>
        </tr>
...
<table dir="rtl" style="width:100%;" border="1" align="center" class="table table-bordered table-hover ">  <tr  >
  ...
  <?php include('dbcon/config.php');
  $sql=mysql_query("select * from expn where etype='$_POST[exp]' and year='$_POST[year]' order by etype desc");
  $row=mysql_fetch_array($sql);
   do { ?>
  <tr >
    <td nowrap><span class="style5"><?php echo $row['exid'];?></span></td>
  ...
  <tr >
    <td nowrap><strong>مجموع المصروفات</strong></td>
    <td nowrap ><?php include('dbcon/config.php');	$sql=mysql_query("select count(exid) from expn where etype='$_POST[exp]' and year='$_POST[year]'"); $row=mysql_fetch_array($sql); echo $row['count(exid)'];?></td>
	<td></td>
	    <td nowrap><strong>الإجمالي</strong></td>
    <td nowrap ><?php include('dbcon/config.php');	
	$sql=mysql_query("select sum(cost) from expn where etype='$_POST[exp]' and  year='$_POST[year]'"); $row=mysql_fetch_array($sql); echo $row['sum(cost)'];?> ريال</td>
...
<table style="width:100%;" border="1" align="center" class="table table-bordered table-hover ">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            <td align="center">التاريخ <?php echo date('y-m-d h:i:s');?></td>
            <td align="center"> <strong> تقرير مصروفات المستخدم <?php echo $_POST['exp'];?> للعام <?php echo $_POST['year'];?></strong></td>
            <td align="center"> تقارير المصروفات </td>
        </tr>
...
<table dir="rtl" style="width:100%;" border="1" align="center" class="table table-bordered table-hover ">  <tr  >
  ...
  <?php include('dbcon/config.php');
  $sql=mysql_query("select * from expn where user='$_POST[exp]' and year='$_POST[year]' order by etype desc");
  $row=mysql_fetch_array($sql);
   do { ?>
  <tr >
    <td nowrap><span class="style5"><?php echo $row['exid'];?></span></td>
  ...
  <tr >
    <td nowrap><strong>مجموع المصروفات</strong></td>
    <td nowrap ><?php include('dbcon/config.php');	$sql=mysql_query("select count(exid) from expn where user='$_POST[exp]' and year='$_POST[year]'"); $row=mysql_fetch_array($sql); echo $row['count(exid)'];?></td>
	<td></td>
	    <td nowrap><strong>الإجمالي</strong></td>
    <td nowrap ><?php include('dbcon/config.php');	$sql=mysql_query("select sum(cost) from expn where user='$_POST[exp]' and  year='$_POST[year]'"); $row=mysql_fetch_array($sql); echo $row['sum(cost)'];?></td>
  </tr>
</table>
<br>
<table style="width:100%; "  align="center" class="table table-bordered table-hover "  dir="rtl">
    <tr><td style="width:12%; "><strong>طبع بواسطة</strong></td><td><?php echo $_SESSION['uname'];?></td></tr>
</table>
<br>
