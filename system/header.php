                ...
                <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                    ...
                    <li class="d-none d-sm-block">
                        <a  class="app-search" href="crecord.php">
                            <div class="app-search-box">
                                <div class="input-group">
                                <button type="button" class="form-control" > العمـلاء </button>
                                    <div class="input-group-append">
                                        <button class="btn" type="submit">
                    ...
                    <li class="d-none d-sm-block">
                        <a href="#" class="app-search">
                            <div class="app-search-box">
                                <div class="input-group">
                                <button onclick="goBack()" type="button" class="form-control" > السابـق </button>
                                    <div class="input-group-append">
                                        <button class="btn" type="submit">
...
<li class="d-none d-sm-block">
    <a  class="app-search" href="../Systeme/">
        <div class="app-search-box">
            <div class="input-group">
            <button type="button" class="form-control" > إنجليزي </button>
                <div class="input-group-append">
                    <button class="btn" type="submit">
                    ...
                    <div id="sidebar-menu" style="font-family: 'Droid Arabic Kufi';">
                        ...
                        <li>
                                <a href="index.php">
                                    ...
                                    <span style="font-family: 'Droid Arabic Kufi';"> الرئيسيــــــــــــــــة </span>
                                </a>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="add_reports.php">تقاريــــــر مشتريات</a></li>
                                </ul>
                            </li>
                            <li>
                                    <a href="javascript: void(0);">
                                        <i class="fas fa-boxes"></i>
                                        <span style="font-family: 'Droid Arabic Kufi';"> إدارة المخــــــــزن 
                                        <?php
                                if ($store_num != 0) {
                                ?>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="../sales/exe.php">المبيعـــــــــــــــــــــات</a></li>
                     ...
                     <!--           
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="salesinfo.php">تقارير المبيعــــات</a></li>
                                        <li><a href="storereprt.php">تقارير المخـــــــــزن</a></li>
                                        <li><a href="add_report.php">تقارير المشتريات</a></li>
                                        <li><a href="tax.php">تقرير الضريبـــــــــة</a></li>
                            ...
                            <li>
                                    ...
                                    <li><a href="alert.php">تقرير التنبيهــات</a></li>
                                    </ul>
                                </li>
