...
<table style="width:100%;" border="1" align="center" class="table table-bordered">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            ...
            <td align="center"><strong>فاتورة سداد مستحقات</strong></td>
            <td align="center"> فاتورة سداد </td>
        </tr>
...
<table style="width:100%;" align="center" border="1" class="table table-bordered table-hover">
	...
	<td style="width:10%;" >الرقم الضريبي</td>
...
<table style="width:100%; " align="center" border="1" class="table table-bordered table-hover">
    ...
    <td nowrap style="width:10%; "><strong>المبلغ الكلي</strong></td>
    <td nowrap style="width:10%; "><strong> المبلغ المطلوب</strong></td>
    <td nowrap style="width:10%; "><strong>المدفوع</strong></td>
    <td nowrap style="width:12%; "><strong>المتبقي</strong></td>
    <td nowrap style="width:12%; "><strong>التاريخ</strong></td>
  </tr>
    <?php
...
<td style="width:15%;"><a href="index.php"><button class="btn btn-raised gradient-pomegranate white" style="width: 100%;"> النظام <i class="fa ft-home"></i></button></a></td>
...
{
echo "<script> alert('لم يكتمل الإجراء');</script>";
