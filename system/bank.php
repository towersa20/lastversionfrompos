...
<form name="form1" method="post" action="bank.php">
  <table style="width:100%; font-size:14px; " align="center" class="table table-bordered table-hover " >
    ...
    <tr>
      <td colspan="3">تسجيل البنوك <i class=" fab fa-accusoft "></i></td>
    </tr>
    <tr>
      <td style="width:6%;"><strong>البنــــك</strong></td>
  ...
  <table style="width:100%; " align="center" class="table table-borderd table-hover  " >
    <tr>
      ...
      <td style="width:15%;"><button  type="submit" name="ok" class="btn btn-primary" style="width:100%; font-family: 'Droid Arabic Kufi';"> حــفظ <i class="fa fa-check"></i></button></td>
...
?>
<tr align="center">
<td style="width:90%;"><strong>إسم البنك</strong></td>
<td colspan="2"><strong>التحكم</strong></td>
</tr>
<?php do { ?>
<tr>
<td nowrap><?php echo $row['name'];?></td>
<td align="center"><a href="delete.php?&&bid=<?php echo $row['bid'];?>" onClick="return confirm('هل تريد حذف <?php echo $row['name'];?>');">
        <button class="btn btn-danger" style="width: 100px; font-family: 'Droid Arabic Kufi';"> حذف <i class="fa fa-times"></i></button></a></td>
<td align="center"><a href="upbank.php?&&bid=<?php echo $row['bid'];?>"> <button class="btn btn-primary" style="width: 100px; font-family: 'Droid Arabic Kufi';"> تعديل <i class="fa fa-edit"></i></button></a></td>
</tr>
