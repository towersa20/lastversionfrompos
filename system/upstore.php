...
{
echo "<script> alert ('لم يتم تعديل بيانات المخزن');</script>";
...
<form name="form1" method="post" action="" enctype="multipart/form-data">
  <table style="width:100%; " align="center" class="table table-bordered table-hover">
    <tr>
      <td colspan="6">تعديــل بيانات المخـزن <i class="fa fa-th-large"></i> </td>
    </tr>
    <tr>
      <td style="width:9%;">المخزن</td>
    ...
    <tr>
      ...
      <td style="width:15%;"><a href="index.php"><button type="button" class="btn btn-primary" style="width:100%; font-family: 'Droid Arabic Kufi';"> النظام <i class="fa fa-home"></i></button></a></td>
    </tr>
  </table>
</form>
</div>
   ...
   <div class="modal-dialog modal-notify modal-success" role="document">
     ...
     <div class="modal-content">
       ...
       <div class="modal-header">
         <strong class="heading lead">تعديل مخزن</strong>
