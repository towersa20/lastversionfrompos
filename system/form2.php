...
<center><table align="center" style="width:100%;" dir="rtl" border="1" class="table table-bordered table-hover">
  <tr align="center">
    <td nowrap style="width:13%; "><strong>رقم الباركود</strong></td>
    <td nowrap style="width:25%; "><strong>أسم الصنـف</strong></td>
    <td nowrap style="width:12%; "><strong>الوحدة</strong></td>
    <td nowrap style="width:8%; "><strong>الكمية</strong></td>
    <td nowrap style="width:8%; "><strong>سعر الشراء</strong></td>
    <td nowrap style="width:8%; "><strong>الضريبة</strong></td>
    <td nowrap style="width:8%; "><strong> الاجمالي شامل الضريبة</strong></td>
  </tr>
        <?php
...
{?>
  <tr>
    ...
    <td nowrap> <?php $xx2=$_POST['price'][$i];  $xx2 = sprintf("%01.2f", $xx2);  echo $xx2;?> </td>
...
<tr>
        <td style="width:20%;"><button type="submit" class="btn  btn-primary" id='btn'  style="width: 100%;font-family: 'Droid Arabic Kufi';"  onclick="printDiv(); javascript:window.close()"> طباعة <i class="fa fa-print"></i></button></td>
</form> 
        <td style="width:20%;"><a href="move.php"> <button type="button" id='btn'  class="btn btn-primary" style="width: 100%;font-family: 'Droid Arabic Kufi';" onclick="printDiv(); javascript:window.close()"> جديد <i class="fa fa-shopping-basket"></i></button></a></td>
        <td style="width:20%;"><a href="vshare.php"> <button type="button" class="btn  btn-primary" style="width: 100%;font-family: 'Droid Arabic Kufi';"> إستعلام <i class="fa fa-search"></i></button></a></td>
        <td style="width:20%;"><a href="shselect1.php"> <button type="button" class="btn btn-primary" style="width: 100%;font-family: 'Droid Arabic Kufi';"> التقارير <i class="ft-pie-chart"></i></button></a></td>
        <td style="width:20%;"><a href="index.php"> <button type="button" class="btn  btn-primary" style="width: 100%;font-family: 'Droid Arabic Kufi';"> النظام <i class="fa fa-home"></i></button></a></td>
</tr></table>
   ...
   <div class="modal-dialog modal-notify modal-success" role="document">
     ...
     <div class="modal-content">
       ...
       <div class="modal-footer justify-content-center">
         <a href="move.php" type="button" class="btn btn-primary waves-effect" style="width: 100%; font-family: 'Droid Arabic Kufi';" data-dismiss="">موافـق</a>
       </div>
     </div>
     <!--/.Content-->
   </div>
