...
<form name="form1" method="post" action="store.php" enctype="multipart/form-data">
  <table style="width:100%; " align="center" class="table table-bordered table-hover ">
    <tr>
      <td colspan="6">نافذة تسجيل مخزن جديد <i class="fa fa-th-large"></i></td>
    </tr>
    <tr>
      <td style="width:10%;">المخزن</td>
      <td colspan="5"><input type="text" placeholder="إسم المخزن" name="a" class="form-control" required autocomplete="off"></td>
    </tr>
  ...
  <table style="width:100%; " align="center" class="table table-borderd table-hover" >
    <tr>
      ...
      <td style="width:25%;"><button  type="submit" name="ok" class="btn btn-primary" style="width:100%; font-family: 'Droid Arabic Kufi';"> تسجيل <i class=" fab fa-accusoft "></i></button></td>
...
?>
<tr align="center">
<td style="width:70%; ">إسم المخزن</td>
<td colspan="2" style="width:30%;">التحكم</td>
</tr>
<?php do { ?>
<tr>
<td nowrap><?php echo $row['name'];?></td>
<td align="center"><a href="delete.php?&&sid=<?php echo $row['sid'];?>" onClick="return confirm('هل تريد حذف <?php echo $row['name'];?>');">
        <button class="btn btn-danger" style="width: 100%;font-family: 'Droid Arabic Kufi';" onclick="doConfirm()"> حذف <i class="fa fa-times"></i></button></a></td>
<td align="center"><a href="upstore.php?&&sid=<?php echo $row['sid'];?>">    <button class="btn btn-primary" style="width: 100%;font-family: 'Droid Arabic Kufi';"> تعديل <i class="fa fa-edit"></i></button>
    </a></td>
</tr>
   ...
   <div class="modal-dialog modal-notify modal-success" role="document">
     ...
     <div class="modal-content">
       ...
       <div class="modal-header">
         <strong class="heading lead">نظام المبيعات</strong>
