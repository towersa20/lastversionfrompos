...
<!-- نموذج اضافة البيانات بجدول المخزن -->
<form name="form1" method="post" action="storing.php">
<table class="table table-bordered table-hover" style="font-size: 14px;">
    <tr>
      <td colspan="8">تخزين صنـف بالمخزن   <i class="fab fa-accusoft"></i> </td>
    </tr>
	    <tr>
		<td>الباركود</td>
...
<td><select name="unit" class="selectpicker" data-live-search="true" data-style="btn-primary">
      ...
      <td style="width: 8%;" nowrap>تاريخ </td>
      ...
      <td style="width: 8%;" nowrap>المخزن</td>
...
<table style="width:100%; " align="center" class="table table-borderd table-hover">
    <tr>
      ...
      <td style="width:18%"><button type="submit" name="ok" class="btn btn-success" style="width: 100%; font-family: 'Droid Arabic Kufi';"> تخزيــــن  <i class="fa fa-th-large"></i></button></td>
      <td style="width:18%"><a href="index.php"><button type="button" class="btn btn-primary" style="width: 100%; font-family: 'Droid Arabic Kufi';"> النظام <i class="fa fa-home"></i></button></a></td>
      <td style="width:18%"><a href="store.php"><button type="button" class="btn btn-danger" style="width: 100%; font-family: 'Droid Arabic Kufi';"> مخزن جديد <i class="fa fa-th-large"></i></button></a></td>
    </tr>
  </table>
</form>
<!-- نهاية فورم الفاتورة -->
...
<td style="width:18%;"> الصــنف</td>
<td style="width:10%;">الوحده</td>
<td style="width:10%;">الكمية</td>
<td style="width:10%;"> البيع</td>
<td colspan="3" style="width:14%;">التحكم</td>
</tr>
...
<tr <?php
// اضافة لون للنص حسب الكمية المتبقية بالمخزن
if($row['qunt']<10 ) 
{
...
<td align="center"><a href="delete.php?&&xsid=<?php echo $row['sid'];?>" onClick="return confirm('هل تريد حذف <?php echo $row['name'];?>');"><button class="btn btn-danger" style="width: 100px; font-family: 'Droid Arabic Kufi';"> حذف <i class="fa fa-trash"></i></button></a></td>
<td align="center"><a href="upstoring.php?&&xsid=<?php echo $row['sid'];?>"><button class="btn btn-primary" style="width:100px;font-family: 'Droid Arabic Kufi';"> تعديل <i class="fa fa-edit"></i></button></a></td>
<td align="center"><a href="storeview.php?&&barco=<?php echo $row['barco'];?>&&info=<?php echo $row['name'];?>"><button class="btn btn-warning" style="width: 100px;font-family: 'Droid Arabic Kufi';"> تفاصيل <i class="fas fa-clipboard-list"></i></button></a></td>
</tr>
...
else
{
  ...
  // كود اضافة كمية جديدة الي كمية موجودة بالمخزن
...
// تسجيل البيانات بجدول حركة المخزن
include('dbcon/dbcon.php');
if(isset($_POST['ok']))
{
$a=$_POST['a'];
...
<?php
// كود تحديث بيانات السعر بجدول الاصناف
include('dbcon/dbcon.php');
if(isset($_POST['ok']))
{
  // تعريف المتغيرات
...
{
  //إضافة بيانات جديده في حاله لايوجد بيانات من نفس الصنف
