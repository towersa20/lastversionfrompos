...
<form name="form1" method="post" action="">
  <table style="width:100%; " align="center" class="table table-bordered table-hover">
    <tr>
      <td colspan="8">تخزين صنـف جديد  <i class="fab fa-accusoft"></i> </td>
    </tr>
	    <tr>
...
<td><input type="text"  name="unit" class="form-control big-shadow " required id="search" placeholder="اختر الوحـــــدة" list="searchunit" autocomplete="off">
    ...
    <tr>
        ...
        <td style="width:18%">&nbsp;</td>
        <td style="width:18%">&nbsp;</td>
        <td style="width:15%"><button type="submit" name="ok" class="btn btn-primary" style="width: 100%;  font-family: 'Droid Arabic Kufi';"> تعديل  <i class="fa fa-th-large"></i></button></td>
        ...
        <td style="width:15%"><a href="store.php"><button type="button" class="btn btn-info" style="width: 100%;  font-family: 'Droid Arabic Kufi';"> تسجيل مخزن <i class="fa fa-th-large"></i></button></a></td>
    </tr>
  </table>
</form>
