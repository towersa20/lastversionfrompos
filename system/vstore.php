...
<td colspan="2"><span style="color:#000000; font-size: 14px;">إستعلام في سجلات المخزن</span> <i class="fa fa-th-large"></i></td>
</tr><tr>
<td> <input type="text"  class="form-control big-shadow" style="font-size:18px;" autofocus placeholder="أدخل اسم الصنف" onkeyup="showHint(this.value)"></td>
