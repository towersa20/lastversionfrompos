...
<tr>
<td style="width: 10%;">إسم العميل</td>
<td colspan="3">
<select name="a" class="selectpicker" data-live-search="true" data-style="btn-primary">
    ...
    <option value="0"> أختر العميـل</option>
    <?php do{?>
...
<td>
    <button class="btn btn-primary" type="submit" style="width:100%; width: 100%; font-family: 'Droid Arabic Kufi';" name="ok"> حفظ <i class="fa fa-edit"></i></button>
</td>
<td><a href="index.php">
    <button class="btn btn-primary" style="width:100%; width: 100%; font-family: 'Droid Arabic Kufi';" name="ok"> الرجوع <i class="fa fa-home"></i></button>
...
<td align="center"><a href="delete.php?&&paymentid=<?php echo $row['id'];?>" onClick="return confirm('هل تريد حذف <?php echo $row['name'];?>');">
