...
<td colspan="2"><span style="color: #000000; font-size: 16px">إستعلام في سجلات حركة المخزن</span> <i class="fa fa-th-large"></i></td>
</tr><tr>
<td> <input type="text"  class="form-control big-shadow" style="font-size:18px;" placeholder="أدخل اسم الصنف" onkeyup="showHint(this.value)"></td>
</tr></form>
</table>
