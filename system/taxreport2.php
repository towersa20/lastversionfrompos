...
<form name="form1" method="post" action="tax2.php">
    ...
    <tr>
      <td colspan="5">عرض تقرير الضريبة الـــــدوري <i class="fa icon-basket-loaded"></i></td>
    </tr>
    <tr>
    ...
    <td style="width:15%; "><button type="submit" name="ok1" class="btn btn-primary" style="font-family: 'Droid Arabic Kufi';width: 100%;"> عــرض <i class="fa icon-basket-loaded"></i></button></td> </tr>
  </table>
</form>
<br>
