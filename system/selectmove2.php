...
function printDiv() 
{
  ...
  newWin.document.write('<html><title>حركة المخزن</title><body border="3" dir="rtl" onload="window.print()">'+divToPrint.innerHTML+'</body></html>');
...
<table style="width:100%;" border="1" align="center" class="table table-bordered table-hover animated flipInX">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            ...
            <td align="center"><strong>تفاصيل حركة المخزن من <?php echo $_POST['date1'];?> الي <?php echo $_POST['date2'];?></strong></td>
...
<table style="width:100%;" border="1" align="center" class="table table-bordered table-hover animated flipInX">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            <td nowrap="" style="width: 22%;" align="center">تاريخ   20<?php echo date('y-m-d h:i:s');?></td>
            <td align="center"><strong>تفاصيل حركة مخزن <?php echo $_POST['store'];?> من يوم <?php echo $_POST['date1'];?> الي <?php echo $_POST['date2'];?> </strong></td>
            <td nowrap="" style="width: 22%;" align="center">بيانات المخزن </td>
        </tr>
		<tr>
