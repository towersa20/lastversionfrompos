...
<form action="add_product.php" method="POST">
   ...
   <input type="hidden" name="c[]" value="<?php echo $row['unit'];?>">
    ...
    <tr>
    <td style="width:14%;"><button name="ok" class="btn " style="background-color:red; width: 100%;height:100px; font-size:20px; font-family: 'Droid Arabic Kufi';"> تفعيل المشتريات <i class="fa fa-qrcode"></i> </button></td>
