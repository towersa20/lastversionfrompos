...
<tr><td colspan="4"><input type="button" class="form-control round btn-primary" value="تقارير مخططات العمليات اليومية"></td>
</tr>
<tr>
<td colspan="2"><a href="chart1.php"><input type="button" class="form-control round btn-black" value="مخطط1"></a></td>
<td colspan="2"><a href="chart2.php"><input type="button" class="form-control round btn-black" value="مخطط2"></a></td>
</tr>
</table>
							<br>
							<br>
