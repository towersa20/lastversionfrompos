...
<br>
    ...
    <table style="width:100%; "  align="center" class="table table-bordered table-hover animated flipInX">
        <form>
<tr>
<td colspan="2"><span style="font-size: 14px"><strong>Searching suppliers' payment records</strong> <i class="fa ft-layers"></i></span></td>
</tr><tr>
<td> <input type="text"  class="form-control" style="font-size:14px;" placeholder="Search" onkeyup="showHint(this.value)"></td>
</tr></form>
</table>
