    ...
    <?php do { ?><tr>
      <td align="center" style="width:25%;" ><?php echo '<img src="./file/' .$query['imge']. '"width="110" height="100"> '; ?></td>
        ...
        <tr>
            ...
            <td align="center"><strong>Daily Report <?php echo $_POST['date'];?> </strong></td>
            <td align="center"> <strong>Tax Reports</strong> </td>
        </tr>
...
<tr><td colspan="7"  style="background-color:#FFFFCC;"><strong>Tax Sales</strong></td></tr>
    <tr align="center">
    <td nowrap style="width:12%;"><strong>Bill ID</strong></td>
      ...
      <td nowrap style="width:7%;"><strong>Tax</strong></td>
      <td nowrap style="width:7%;"><strong>Time</strong></td>
    </tr>
		  <?php do { ?>
...
$row=mysql_fetch_array($sql);?>
<table style="width:50%;  font-size: 13px;" border="1"  align="right" class="table table-bordered table-hover"  dir="rtl">
<tr><td colspan="7" style="background-color:#FF9999;"><strong>Purchases</strong></td></tr>
    <tr align="center">
    <td nowrap style="width:12%;"><strong>Bill ID</strong></td>
      <td nowrap style="width:12%;"><strong>Product</strong></td>
      <td nowrap style="width:7%;"><strong>Qunatity</strong></td>
      <td nowrap style="width:7%;"><strong>Price</strong></td>
      <td nowrap style="width:7%;"><strong>Total</strong></td>
      <td nowrap style="width:7%;"><strong> Tax</strong></td>
      <td nowrap style="width:7%;"><strong>Total</strong></td>
...
<table style="width:30%;  font-size: 13px;" border="1"   align="center" class="table table-bordered table-hover"  dir="ltr">
<tr>

<td colspan="3" style="background-color:#FFCCCC;" align="right"><strong>Total Tax for Purchases & Sales</strong></td></tr>
<tr>
...
<table dir="rtl" style="width:100%;  font-size: 13px;"  border="1" align="center" class="table table-bordered table-hover">
    ...
    <?php do { ?><tr>
      <td align="center" style="width:25%;" ><?php echo '<img src="./file/' .$query['imge']. '"width="110" height="100"> '; ?></td>
        ...
        <tr>
            <td align="center">date <?php echo date('y-m-d h:i:s');?></td>
            <td align="center">Reports For  <?php echo $_POST['item'];?> date <?php echo $_POST['date'];?></td>
            <td align="center"> Purchases Reports </td>
        </tr>
...
$row=mysql_fetch_array($sql);?>
<table style="width:50%;  font-size: 13px;" border="1"  align="right" class="table table-bordered table-hover"  dir="rtl">
<tr><td colspan="8"  style="background-color:#FFFFCC;"><strong>Sales Tax</strong></td></tr>
    <tr align="center">
    <td nowrap style="width:12%;"><strong>Bill ID</strong></td>
      <td nowrap style="width:12%;"><strong>Product</strong></td>
      <td nowrap style="width:7%;"><strong>Qunatity</strong></td>
...
$row=mysql_fetch_array($sql);?>
<table style="width:50%;  font-size: 13px;" border="1"  align="right" class="table table-bordered table-hover"  dir="rtl">
<tr><td colspan="8" style="background-color:#FF9999;"><strong>Purchases Tax</strong></td></tr>
    <tr align="center">
    <td nowrap style="width:12%;"><strong>Bill ID</strong></td>
      <td nowrap style="width:12%;"><strong>Product</strong></td>
      <td nowrap style="width:7%;"><strong>Qunatity</strong></td>
...
<table style="width:30%;  font-size: 13px;" border="1"   align="center" class="table table-bordered table-hover"  >
<tr>
