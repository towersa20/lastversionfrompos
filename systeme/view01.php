...
<li class="nav-item"><a class="nav-link active" id="active-tab" data-toggle="tab" href="#active" aria-controls="active" aria-expanded="true"><input type="button" class="form-control round btn-warning" value="تقارير المبيعات"></a></li>
						</ul>
...
<tr>
<td colspan="4">تقارير مبيعات المستخدميـن</td></tr>
<tr>
<td colspan="2"><a href="person.php"><input type="button" class="form-control round btn-success" value="الحسابات"></a></td>
<td colspan="2"></td>
</tr>
</table>
							<br>
