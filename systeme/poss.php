...
<!--  تعريف نوع الخط!-->
    ...
    <body class="sidebar-disable enlarged" style="font-family: 'Droid Arabic Kufi';">
        ...
        <div id="wrapper">
            ...
            <!-- Topbar Start -->
            <div class="navbar-custom" style="background-color: #E80458;">
...
$sql=mysql_query("select * from storing where barco='$_POST[info]'");
...
if($row['barco']=$_POST['info'] and $row['qunt']<1)
{
...
else
{
    ...
    ,now(),'1','$_SESSION[uname]','5','$_SESSION[tell]')");
