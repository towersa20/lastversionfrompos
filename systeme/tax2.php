    ...
    <?php do { ?><tr>
      <td align="center" style="width:25%;" ><?php echo '<img src="./file/' .$query['imge']. '"width="110" height="100"> '; ?></td>
        ...
        <tr>
            ...
            <td align="center"><strong>Tax Report From <?php echo $_POST['date1'];?> To <?php echo $_POST['date2'];?></strong></td>
            <td align="center"> <strong>Tax Report</strong> </td>
        </tr>
...
<tr><td colspan="8"  style="background-color:#FFFFCC;"><strong>Tax</strong></td></tr>
    <tr align="center">
...
<tr><td colspan="7" style="background-color:#FF9999;"><strong>Purchases Tax</strong></td></tr>
    <tr align="center">
    <td nowrap style="width:12%;"><strong>Bill ID</strong></td>
      <td nowrap style="width:12%;"><strong>Product</strong></td>
      <td nowrap style="width:7%;"><strong>Qunatity</strong></td>
...
<td><strong>Purchases Tax</strong></td>
<td><strong>Total</strong></td>
</tr>
<tr>
<td><?php echo $xxx1;?></td>
...
<td style="width:15%;"><a href="vshare.php"><button class="btn btn-primary" style="width: 100%;"> Query <i class="fa ft-search"></i></button></a></td>
