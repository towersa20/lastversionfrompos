...
<form name="form1" method="post" action="">
    ...
    <tr>
	  ...
	  <td colspan="5"><input type="text" name="a" value="<?php echo $row['etype'];?>" class="form-control " required id="search" placeholder="اختر المصروف-" list="searchrt" autocomplete="off">
	<datalist id="searchrt">
      ...
      <td style="width:6%;"> المبلــــــــغ</td>
            <td><input type="number" name="b" class="form-control " value="<?php echo $row['cost'];?>" required autocomplete="off"></td>
      <td>التاريــــــــخ</td>
      <td><input type="date" name="c" class="form-control " value="<?php echo $row['date'];?>" required autocomplete="off"></td>
            <td>المستخـــــدم</td>
            <td><input type="text" name="d" class="form-control " value="<?php echo $row['user'];?>" required autocomplete="off"></td>
            <input type="hidden" name="f" value="20<?php echo date('y');?>">
    </tr>
    <tr>
        <td>البيـــــــــان</td>
        <td colspan="5"><textarea name="e" rows="3"  class="form-control" required autocomplete="off"><?php echo $row['byan'];?></textarea></td>
    </tr>
    </table>
      ...
      <td style="width:15%;"><button  type="submit" name="ok" class="btn btn-primary" style="width:100%;"> تعديل <i class="fa fa-check"></i></button></td>
