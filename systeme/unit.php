...
<form name="form1" method="post" action="unit.php">
  <table style="width:100%; " align="center" class="table table-bordered table-hover animated flipInX">
    ...
    <tr>
      <td colspan="3"><strong>Add New Unit</strong> <i class="fab fa-accusoft"></i></td>
    </tr>
    <tr>
...
<td align="center"><a href="delete.php?&&yid=<?php echo $row['yid'];?>" onClick="return confirm('Do you want Delete <?php echo $row['name'];?>');">
        <button class="btn btn-danger" style="width: 100%;font-family: 'Droid Arabic Kufi';"> Delete <i class="fa fa-times"></i></button></a></td>
<td align="center"><a href="upunit.php?&&yid=<?php echo $row['yid'];?>"><button class="btn btn-info" style="width: 100%;font-family: 'Droid Arabic Kufi';"> Edit <i class="fa fa-edit"></i></button></a></td>
</tr>
