...
function printDiv() 
{
  ...
  newWin.document.write('<html><title>Store</title><body border="3" dir="rtl" onload="window.print()">'+divToPrint.innerHTML+'</body></html>');
...
<table style="width:100%;" border="1" align="center" class="table table-bordered table-hover animated flipInX">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            ...
            <td align="center"><strong>Movement details Store For <?php echo $_POST['date'];?></strong></td>
...
<table style="width:100%;" border="1" align="center" class="table table-bordered table-hover animated flipInX">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            <td nowrap="" style="width: 22%;" align="center">Date   20<?php echo date('y-m-d h:i:s');?></td>
            <td align="center" Dir="ltr"><strong>Day movement details<?php echo $_POST['date'];?> Product <?php echo $_POST['name'];?></strong></td>
            <td nowrap="" style="width: 22%;" align="center">Class movement </td>
        </tr>
		<tr>
...
<table style="width:100%;" border="1" align="center" class="table table-bordered table-hover animated flipInX">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            <td nowrap="" style="width: 22%;" align="center">Date   20<?php echo date('y-m-d h:i:s');?></td>
            <td align="center" dir="ltr"><strong>Details Class movement  <?php echo $_POST['barco'];?> Date <?php echo $_POST['date'];?></strong></td>
            <td nowrap="" style="width: 22%;" align="center">Class movement </td>
        </tr>
		<tr>
...
<table style="width:100%;" border="1" align="center" class="table table-bordered table-hover animated flipInX">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            <td nowrap="" style="width: 22%;" align="center">Date   20<?php echo date('y-m-d h:i:s');?></td>
            <td align="center" dir="ltr"><strong>Details Class movement Store <?php echo $_POST['store'];?> Product <?php echo $_POST['item'];?> Date <?php echo $_POST['date'];?></strong></td>
            <td nowrap="" style="width: 22%;" align="center">Class movement </td>
        </tr>
		<tr>
