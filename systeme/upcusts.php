...
<form name="form1" method="post" action="" enctype="multipart/form-data">
    ...
    <tr>
      <td colspan="8"><strong>Edit Supplier</strong> <i class="fa fa-user"></i></td>
    </tr>
    <tr>
      <td style="width:9%;">Customer </td>
    ...
    <tr>
      <td colspan="8">Product <i class="fa ft-layers"></i></td>
    </tr>
    <tr>
      <td colspan="8"><select multiple name="g" class="selectpicker" data-live-search="true" data-style="btn-primary">
	  <?php include("dbcon/config.php");
	  $sql=mysql_query("select distinct name from share");
	  $row=mysql_fetch_array($sql);
	  ?>
	  <?php do { ?>
	  <option value="<?php echo $row['name'];?>" style="color:red; border:0 " class="form-control  "><?php echo $row['name'];?></option>
	...
	<tr>
        ...
        <td style="width:15%;">&nbsp;</td>
        <td style="width:15%;">&nbsp;</td>
        <td style="width:15%;"><button type="submit" name="ok" class="btn  btn-primary" style="width: 100%;"> Edit <i class="fa fa-check"></i></button></td>
        <td style="width:15%;"><a href="cust.php"><button type="button" class="btn btn-primary" style="width: 100%;"> Home <i class="fa fa-home"></i></button></a></td>
</tr>  </table>
</form>
</div>
</body>
