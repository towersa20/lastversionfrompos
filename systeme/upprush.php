...
<form name="form1" method="post" action="">
 <table style="width:100%; " align="center" class="table table-bordered table-hover  ">
    ...
    <td colspan="8">Edit <i class="fa fa-shopping-basket"></i> </td>
    ...
    <td nowrap colspan="5"><input type="text"   value="<?php echo $row['name'];?>" name="b" class="form-control big-shadow" required id="search" placeholder="Select Product" list="searchrt" autocomplete="off">
  ...
  <td nowrap colspan="3"><input type="text"   name="l" value="<?php echo $row['customer'];?>" class="form-control big-shadow" required id="search" placeholder="select supplier" list="searchrcus" autocomplete="off">
  ...
  <td> Stutas</td>
  <td><input type="text"   name="xw" value="<?php echo $row['tell'];?>" class="form-control big-shadow" required id="search" placeholder="select type" list="searrcus" autocomplete="off">
  <datalist id="searrcus">

  <option value="مشتريات">Returns </option>
  <option value="مرودات مشتريات">Returns purchases</option>


  </datalist></td>
     
  <td nowrap>Bill No </td>
  <td nowrap><input type="text" name="n"   style="border: 0px; color: red;" value="<?php echo $row['formid'];?>" class="form-control big-shadow" required autocomplete="off"></td>
   ...
   <!--- بداية جدول ازار التعديل والتنقل -->
    ...
    <tr>
      ...
      <td style="width: 16.6%;" nowrap>&nbsp;</td>
      <td style="width: 16.6%;" nowrap>&nbsp;</td>
    <td style="width: 16.6%;"><button type="submit" name="ok" class="btn btn-warning" style="width: 100%; font-family:'Droid Arabic Kufi';"> Edit  <i class="fa fa-edit"></i></button></td>
        <td style="width: 16.6%;"><a href="index.php"> <button type="button" class="btn btn-primary" style="width: 100%; font-family:'Droid Arabic Kufi';"> Home <i class="fa fa-home"></i></button></a></td></tr>
    </tr>
  </table>
