...
<form name="form1" method="post" action="" enctype="multipart/form-data">
  <table style="width:100%; " align="center" class="table table-bordered table-hover  " >
    <tr>
      <td colspan="4" class="">Edit Bank <i class=" fab fa-accusoft "></i></i></td>
    </tr>
    <tr>
      <td nowrap style="width:5%; ">Name</td>
   ...
   <div class="modal-dialog modal-notify modal-success" role="document">
     ...
     <div class="modal-content">
       ...
       <div class="modal-footer justify-content-center">
         <a href="bank.php" type="button" class="btn btn-Primary waves-effect" style="width: 50%; font-family: 'Droid Arabic Kufi';" data-dismiss="">OK <i class=" fas fa-user-shield "></i></a>
       </div>
     </div>
     <!--/.Content-->
   </div>
