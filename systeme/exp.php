...
<form name="form1" method="post" action="exp.php">
  <table style="width:100%; " align="center" class="table table-bordered table-hover " >
    ...
    <tr>
      <td colspan="4"><strong>Expense Classifications</strong> <i class="fa ft-layers"></i></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="width:15%;"><button  type="submit" name="ok" class="btn btn btn-primary" style="width:100%;font-family: 'Droid Arabic Kufi';"> Save <i class="fa fa-check"></i></button></td>
...
<td align="center"><a href="delete.php?&&xid=<?php echo $row['xid'];?>" onClick="return confirm('Do you want Delete <?php echo $row['name'];?>');">
        <button class="btn btn btn-danger" style="width: 100px;font-family: 'Droid Arabic Kufi';"> Delete <i class="fa fa-trash-o"></i></button></a></td>
<td align="center"><a href="upexp.php?&&xid=<?php echo $row['xid'];?>"><button class="btn btn-primary" style="width: 100px;font-family: 'Droid Arabic Kufi';"> Edit <i class="fa fa-edit"></i></button></a></td>
</tr>
   ...
   <div class="modal-dialog modal-notify modal-success" role="document">
     ...
     <div class="modal-content">
       ...
       <div class="modal-footer justify-content-center">
         <a href="exp.php" type="button" class="btn btn-Primary waves-effect" style="width: 50%; font-family: 'Droid Arabic Kufi';" data-dismiss="">Ok <i class=" fas fa-user-shield "></i></a>
       </div>
     </div>
     <!--/.Content-->
   </div>
