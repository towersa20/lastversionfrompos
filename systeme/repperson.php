...
<table style="width:100%;font-size:14px;" border="1" align="center" class="table table-bordered">
    ...
    <?php do { ?><tr>
        ...
        <tr>
            ...
            <td align="center"><strong>Customer Reports</strong></td>
...
<td nowrap style="width: 10%;">Account ID</td>
<td nowrap style="width: 20%;">Bank</td>
<td nowrap style="width: 20%;">Date</td>
</tr>
<?php do { ?>
<tr>
