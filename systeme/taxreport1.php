...
<form name="form1" method="post" action="tax1.php" >
  <table style="width:100%; " align="center" class="table table-bordered table-hover">
    <tr>
      <td colspan="3">View your daily tax report <i class="fa fa-qrcode"></i></td>
    </tr>
    <tr>
      ...
      <td style="width:15%; "><button type="submit" name="ok1" class="btn btn-primary" style="font-family: 'Droid Arabic Kufi';width: 100%;"> View <i class="fa ft-activity"></i></button></td>
    </tr>
  </table>
</form>
<br>
<form name="form1" method="post" action="tax1.php" >
  <table style="width:100%; " align="center" class="table table-bordered table-hover">
    <tr>
      <td colspan="5">View the tax report for an Product  <i class="fa fa-qrcode"></i></td>
    </tr>
    <tr>
	...
	<datalist id="searchrt">
      ...
      <td style="width:8%;">Day</td>
      <td><input type="date" value="20<?php echo date('y-m-d');?>"  name="date" class="form-control big-shadow" required autocomplete="off"></td>
      <td style="width:15%; "><button type="submit" name="ok2" class="btn btn-primary" style="font-family: 'Droid Arabic Kufi'; width: 100%; "> view <i class="fa ft-activity"></i></button></td>
    </tr>
  </table>
</form>
