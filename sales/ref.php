                        ...
                        <div class="container-fluid">
                            <div style="background-color: #E80458;" class="row">
                                ...
                                <div class="col-md-12  offset-md-3">
                                    <h5 style="color: #eff5fc;text-align: center; font-family: 'Droid Arabic Kufi'; font-size:18px; ">البحث عن فاتورة مرتجعات</h5>
                                </div>
                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="width:88%;">
                                                            <div class="input-group">
                                                                <input type="text" autocomplete="off" id="suggestions_value" class="form-control" required style="font-size:15px; color:red;" placeholder="أدخل كلمة البحث" name="invoice">
                                                                <br>
                                                        ...
                                                        <td style="width:12%;">
        <button type="submit" class="form-control btn btn-info" style="font-size: 15px; color:#fff;" > بحث <i class="fa fa-search"></i></button>
                                                        </td>
