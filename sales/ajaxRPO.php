	...
	'target':document
                                                ...
                                                <tr>
                                                    <td style="width:16.6%;">
                                                             ...
                                                             <a href="print4.php?print=<?= $_GET['invoice_Id'] ?>" type="button" style="background-color:#0595B7; font-size:16px; height:40px; width:100%; font-family: 'Droid Arabic Kufi';" class="btn btn-rounded">
