                        ...
                        <div class="container-fluid">
                            <div style="background-color: #0595B7;" class="row">
                                ...
                                <div class="col-md-12  offset-md-3">
                                    <h4 style="color: #eff5fc;text-align: center;">فاتورة مبيعات</h4>
                                </div>
                            </div>
...
<input type="text" autocomplete="off" id="suggestions_value" class="form-control" style="font-size:18px; color:red;" placeholder="أدخل كلمة البحث" name="search">
...
<!-- مؤسسة برجي التقني نظام المبيعات -->
                                        ...
                                        <div style="height: 250px;overflow: scroll;margin: 14px 0;">
                                            ...
                                            <table class="table table-bordered tab-content table-embed-responsive" style="background-color: #eff5fc; width: 100%; font-family: 'Droid Arabic Kufi'; font-size:15px;  font-family: 'Droid Arabic Kufi'; ">
                                                ...
                                                <thead>
                                                    <tr align="center">
                                                        <th style=" font-family: 'Droid Arabic Kufi';">الصنف</th>
                                                        <th style=" font-family: 'Droid Arabic Kufi';">الوحده</th>
                                                        <th style=" font-family: 'Droid Arabic Kufi';">الكمية</th>
                                                        <th style=" font-family: 'Droid Arabic Kufi';">السعر</th>
                                                        <th style=" font-family: 'Droid Arabic Kufi';">المبلغ</th>
                                                        <th style=" font-family: 'Droid Arabic Kufi';">الضريبه</th>
                                                        <th style=" font-family: 'Droid Arabic Kufi';">المبلغ + القيمة</th>

                                                        <th style=" font-family: 'Droid Arabic Kufi';"><i onclick="delete_invoice()" style="color:red" class=" fas fa-times-circle  "></i> إزالة</th>
                                                    </tr>
                                                </thead>
                                    ...
                                    <div class="card-box">
                                        <table class="table table-bordered" style="background-color: #eff5fc; font-family: 'Droid Arabic Kufi'; font-size:14px; ">
                                            <tbody>
                                                <tr>
                                                    <td style="width:16.6%;">
                                                        <a href="print2.php?print=<?php echo $_GET['invoice_Id'] ?>&&discount=0" id="add">
...
shortcut.add("HOME",function() {
	...
	'target':document
                                                ...
                                                <tr>
                                                    <td style="width:16.6%;">
                                                        <a href="exe.php">
                                                            <a href="ref.php" type="button" style="background-color:#0595B7; font-size:16px; height:40px; width:100%; font-family: 'Droid Arabic Kufi';" class="btn btn-rounded">
                                                                <i class="fas fa-minus "></i> مرتجع
                                                            </a>
                                                        </a>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:16.6%;">
                                                        <a href="#" onclick="delete_invoice()"  onclick="return confirm('هل تريد حذف الفاتورة');">
                                                            <button type="button" style="background-color:#0595B7; font-size:16px; height:40px; width:100%; font-family: 'Droid Arabic Kufi';" class="btn btn-rounded">
                                        ...
                                        <div class="container">
                                            ...
                                            <table class="table table-bordered table-hover" style="font-size:15px; padding:05rem;  background-color:#EAE3E3; font-family: Droid Arabic Kufi;  border-radius:1.1em;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="3">
                                                            <input type="text" name="info" autofocus="" style="font-size:15px; background-color: #707070; color:yellow;" class="cal-display  form-control btn-rounded " id="barcode" placeholder="اختر الصنف" autocomplete="off">
                                                        </td>
                                                    </tr>
                                        ...
                                        <table class="table table-borderd" style="background-color: #eff5fc; font-family: 'Droid Arabic Kufi'; font-size:14px; ">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width: 25%;">
                                                        <button type="button" style="background-color:#0595B7; font-size:16px;  width:100%;  font-family: 'Droid Arabic Kufi';" class="btn  btn"><strong>المبلغ</strong></button>
                                                    </td>
                                                    <td style="width:25%;">
                                                    ...
                                                    <td style="width: 25%;">
                                                        <button type="button" style="background-color:#0595B7; font-size:16px;  width:100%;  font-family: 'Droid Arabic Kufi';" class="btn  btn"><strong>الضريبة</strong></button>
                                                    </td>
                                                    <td style="width:25%;">
                                                ...
                                                <tr align="center">
                                                    <td colspan="2">
                                                        <button type="button" style="background-color:#707070; font-size:16px;  width:100%;  font-family: 'Droid Arabic Kufi';" class="btn  btn">المدفوع
                                                        </button>
                                                    </td>
                                                    <td colspan="2">
                                                        <button type="button" style="background-color:#707070; font-size:16px;  width:100%;  font-family: 'Droid Arabic Kufi';" class="btn  btn"> المتبقي
                                                        </button>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <Td colspan="4">
               <input type="number" autocomplete="off" name="discount" value="0" class="form-control" placeholder="مبلغ الخصم" style="color:red;">
                                                    </Td>
                                                </tr>
                                    ...
                                    <strong style="color:red;">
                                        ...
                                        <div class="card-box" style="border-radius:2.2em;" align="center">
                                            <table class="table table-bordered tab-content table-embed-responsive" style="background-color: #eff5fc; width: 100%; font-family: 'Droid Arabic Kufi'; font-size:15px; ">
                                                ...
                                                <tr>
                                                        <td>
                                                        <input type="hidden" name="print" value="<?php echo $_GET['invoice_Id'] ?>">
                                                                <button type="submit" style="background-color:#000000; color:#eff5fc; font-size:15px; height:40px;  width:100%;  font-family: 'Droid Arabic Kufi';" class="btn btn-rounded">
                                                               حفظ بخصم  </button>
                                                            </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td><a href="../System/index.php">
                                                                <button type="button" style="background-color:#0595B7; color:#eff5fc; font-size:15px; height:40px;  width:100%;  font-family: 'Droid Arabic Kufi';" class="btn btn-rounded">
                    ...
                    <div id="customer" class="w3-modal">
                        <div class="w3-modal-content">
                            <div class="w3-container">
                                ...
                                <div class="container">
                                    <div class="col-md-12">
                                        <h3 style="margin-right: 20px;">اضافة عميل</h3>
                                        <hr>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                    ...
                    <div id="id01" class="w3-modal">
                        <div class="w3-modal-content">
                            <div class="w3-container">
                                ...
                                <div class="container">
                                    <div class="col-md-12">
                                        <h3 style="margin-right: 20px;">اضافه صنف غير معروف</h3>
                                        <hr>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <button onclick="add_unknown_product()" style="font-family: 'Droid Arabic Kufi'; width: 250px;" class="btn-info btn btn-md" id="add_unk_product">
                                                    اضافة منتج غير معروف
                                                </button>
<button    onclick="document.getElementById('id01').style.display='none'"    style="font-family: 'Droid Arabic Kufi'; background-color: #E80458; width:250px;" class="btn btn btn-md" data-dismiss="modal">
                ...
                <script>
                    ...
                    function load_products(invoice_id) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "http://127.0.0.1/pos/sales/ajaxPosLoginc.php",
                            data: {
