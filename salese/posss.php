            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <script src="green-rtl/assets/libs/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js">
                        </script>
...
if (isset($_POST['info'])) {
    ...
    $('#centralModalSuccesd').modal('show');
        ...
        $add = mysql_query("insert into sales values('','$search','$a1','1','$a2','$a3','0','$a5',now()
...
if (isset($_GET['delete'])) {
    ...
    $sql = mysql_query("select * from sales where invoice='$_GET[delete]'  ");
    $row = mysql_fetch_array($sql);
    ...
    $up = mysql_query("update storing set qunt='$xmx' where barco='$mi[barco]'");

    if ($up) {
        // حذف الفاتورة
       // $sql = mysql_query("update sales set tell='0'  where invoice='$_GET[delete]'");
...
if (isset($_GET['back'])) {
    ...
    $my = mysql_query("update sales set type='3' where invoice='$search' ");
    // التنبيه بالعملية
...
<!-- Central Modal Medium Success -->
<div class="modal fade" id="centralModalSuccesd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-notify modal-success" role="document">
        <!--Content-->
        <div class="modal-content">
            <!--Header-->
...
if (isset($_GET['unknown'])) {
    ...
    $addnew = mysql_query("insert into sales values('','$search','$barco','1','$ks1','$unknown','0','قطعة',now(),now(),'1','$_SESSION[uname]','0','$_SESSION[tell]')");
...
if (isset($_POST['add_search'])) {
    ...
    $addnew = mysql_query("update job set name='$_POST[search]'");
    echo "<meta http-equiv='refresh' content='0;url=posss.php'>";
} ?>