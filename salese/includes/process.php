...
mysql_select_db("infos",$dbs);
				...
				<input type="text" title="Barcode here" autofocus name="pid[]" style="border:0px; height:36px; " class="form-control big-shadow pid" required id="search" placeholder="باركود" list="searchrxt" autocomplete="off">
	<datalist id="searchrxt">
        <?php do {?>
		    ...
		    <td><input name="qty[]" type="number" min="1" style="border:0px; " class="form-control big-shadow qty" ></td>
		    <td><input name="price[]" type="number" readonly="on" min="1" style="border:0px; "  class="form-control big-shadow price" >
		    </span>
