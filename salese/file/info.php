        ...
        <div class="modal-content">
           ...
           <form name="form1"  action="info.php" method="post" enctype="multipart/form-data" >
		      <table class="table">
                   ...
                   <tr>
                       <td>Org Name</td>
                       <td><input type="text" name="b" class="form-control" required autocomplete="off" placeholder="إسم المؤسسة باللغة الإنجليزية"></td>
                   </tr>
                  <tr>
                      <td>رقم الترخيص</td>
                      <td><input type="Number" name="c1" class="form-control" required autocomplete="off" placeholder="رقم الترخيص"></td>
                  </tr>
                  <tr>
                      <td>الرقم الضريبي</td>
                      <td><input type="Number" name="c2" class="form-control" required autocomplete="off" placeholder="الرقم الضريبي"></td>
                  </tr>
                  <tr>
                      <td>رقم الهاتف</td>
                      <td><input type="Number" name="c" class="form-control" required autocomplete="off" placeholder="رقم الهاتف"></td>
                  </tr>
				                      <tr>
                       <td>البريد الإلكتروني</td>
                       <td><input type="text" name="d" class="form-control" required autocomplete="off" placeholder="البريد الإلكتروني"></td>
                   </tr>
				                      <tr>
                       <td>الموقع الإلكتروني</td>
                       <td><input type="text" name="e" class="form-control" required autocomplete="off" placeholder="الموقع الإلكتروني"></td>
                   </tr>
				                      <tr>
                       <td>العنوان</td>
                       <td><input type="text" name="f" class="form-control" required autocomplete="off" placeholder="العنوان الدائم"></td>
                   </tr>
		
                   <tr>
                       <td>المرفقــات</td>
                       <td><input name="uploadedimage" type="file" class="form-control" required title="صورة مرفقة"/></td>
                   </tr>
