                        ...
                        <div class="container-fluid">
                            <div style="background-color: #0595B7;" class="row">
                                ...
                                <div class="col-md-12  offset-md-3">
                                    <h4 style="color: #eff5fc;text-align: center;">Sales Bills</h4>
                                </div>
                            </div>
...
<td style="width: 20%;">
<div class="input-group">
<input name="customer_name" type="text" placeholder="Customer Name" id="search_customer" class="form-control" style="font-size: 18px; color:red;">
                                            ...
                                            <table class="table table-bordered tab-content table-embed-responsive" style="background-color: #eff5fc; width: 100%; font-family: 'Droid Arabic Kufi'; font-size:15px;  font-family: 'Droid Arabic Kufi'; ">
                                                ...
                                                <thead>
                                                    <tr align="center">
                                                        ...
                                                        <th style=" font-family: 'Droid Arabic Kufi';"><i onclick="delete_invoice()" style="color:red" class=" fas fa-times-circle  "></i> Remove</th>
                                                    </tr>
                                                </thead>
                                    ...
                                    <div class="card-box">
                                        <table class="table table-bordered" style="background-color: #eff5fc; font-family: 'Droid Arabic Kufi'; font-size:14px; ">
                                            <tbody>
                                                <tr>
                                                    <td style="width:16.6%;">
                                                        <a href="print2.php?print=<?= $_GET['invoice_Id'] ?>" id="add" >
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <button onclick="document.getElementById('id01').style.display='block'" type="button" class="btn  btn-rounded form-control" style="height: 40px; font-family: 'Droid Arabic Kufi'; background-color:#707070;" data-toggle="modal" data-target="#sideModalTR">
                                                            <i class=" fas fa-qrcode "> </i> Unknown 
                                                        </button>
                    ...
                    <div id="id01" class="w3-modal">
                        <div class="w3-modal-content">
                            <div class="w3-container">
                                ...
                                <div class="container">
                                    <div class="col-md-12">
                                        <h3 style="margin-right: 20px;">Add Unknown Product</h3>
                                        <hr>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
